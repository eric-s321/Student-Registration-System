 ...
 * 
 * The MainMenu contains most components the user will interact with. 
 * Every possible Panel to be displayed is contained within this class. 
 * Each panel is added to the MainMenu in the constructor but mosts visibilty are set to false. 
 * Differe panels become visible when the selection in actionList (all possible actions the user can take) 
 * is changed so that they are presented with the approriate form
 */
